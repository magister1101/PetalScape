            ...
            <div class="addingOfItems-cont">
                ...
                <div class="products">
                    ...
                    while ($productRows = mysqli_fetch_assoc($productResult)) {
                        $img = $productRows['img'];
                    ?>
                        <div class="productItem <?php echo ($productRows['archive'] == 1) ? 'Unarchive' : 'Archive'; ?>">
                            ...
                            <div class="product-edit-btn">
                                ...
                                <?php if ($productRows['archive'] == 1) {
                                ?>
                                    <a href="functions/func_unarchive_item.php?id=<?php echo $productRows['id']; ?>">Unarchive</a>
                                <?php
                                } else { ?>
                                    <a href="functions/func_archive_item.php?id=<?php echo $productRows['id']; ?>">Archive</a>
                                <?php
                                }
                                ?>
